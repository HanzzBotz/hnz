        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              let wel = `https://api.dhamzxploit.my.id/api/canvas/welcome3?pp=https://telegra.ph/file/0d8089010be9f4ebb76b8.png&name=${encodeURIComponent(this.getName(user))}&bg=https://telegra.ph/file/13c831088950918dba47c.jpg&member=${encodeURIComponent(groupMetadata.participants.length)}&ppgc=https://telegra.ph/file/494e2a8f715400e83887b.jpg&grupname=${encodeURIComponent(this.getName(jid))}`
              let lea = `https://api.dhamzxploit.my.id/api/canvas/goodbye3?pp=https://telegra.ph/file/0d8089010be9f4ebb76b8.png&name=${encodeURIComponent(this.getName(user))}&bg=https://telegra.ph/file/13c831088950918dba47c.jpg&member=${encodeURIComponent(groupMetadata.participants.length)}&ppgc=https://telegra.ph/file/494e2a8f715400e83887b.jpg&grupname=${encodeURIComponent(this.getName(jid))}`
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    unreg: '── 「 TIDAK TERDAFTAR 」 ──\nSilakan Daftar Terlebih Dahulu Sebelum Menggunakan Hanzz Botz. Cara Daftar Cukup Dengan Command *#daftar nama.umur*\nContoh #daftar manusia.17\nNote:\nHarap Save Serial Number Mu Agar Bisa Melakukan Unreg Database Bot'
  }[type]
