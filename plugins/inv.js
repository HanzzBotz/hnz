...
let handler = async (m, { conn, usedPrefix }) => {
    ...
    let str = `
⚒️Inventory *${name.vnmae || name.notify || name.name || ('+' + name.jid.split`@`[0])}*\n
♥️Health: *${healt}*
...
⚒️Total Inventory: *${diamond + potion + sampah + makananpet}* item\n
🎁 *Crate*
🎁Common: *${common}*
🎁Uncommon: *${uncommon}*
🎁Mythic: *${mythic}*
...
Pet: *${pet}*\n
*Pet*
🐼Panda: *${kuda == 0 ? 'Tidak Punya' : '' || kuda == 1 ? 'Level 1' : '' || kuda == 2 ? 'Level 2' : '' || kuda == 3 ? 'Level 3' : '' || kuda == 4 ? 'Level 4' : '' || kuda == 5 ? 'Level MAX' : ''}*
...
╰────────────────
╭────────────────
│🐼Panda ${kuda == 0 ? 'Tidak Punya' : '' || kuda > 0 && kuda < 5 ? `Level *${kuda}* To level *${kuda + 1}*\n│Exp *${_kuda}* -> *${kuda *100}*` : '' || kuda == 5 ? '*Max Level*' : ''}
╰────────────────\n\n
*achievement*
